(function () {
    ...
    app.directive('circularType', function () {
        return {
            restrict: 'E',
            templateUrl: "/app/templates/labelCircularType.html",
            link: function ($scope, $element, $attrs) {
                $scope.getCircularTypeClass = function () {
                    if ($attrs.circularType == 1) {
                        return 'label label-success'
                    }
                    else {
                        return 'label label-warning'
                ...
                $scope.getCircularTypeValue = function () {
                    if ($attrs.circularType == 1) {
                        return 'Cadre'
                    }
                    else {
